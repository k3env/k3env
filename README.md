...
- 🔭 I’m currently working on some projects, like [Helm chart for Appwrite](https://github.com/k3env/appwrite-helm) or [my K3s deployment playbook](https://github.com/k3env/k3s-boot)
- 👯 I’m looking for job as backend (C# or Node.js) or frontend (Angular) developer (intern/junior)
